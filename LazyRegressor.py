    ...
    def fit(self, X_train, X_test, y_train, y_test):
        ...
        for name, model in tqdm(self.regressors):
            ...
            try:
                ...
                adj_rsquared =  1 - (1 - r_squared) * ((X_test.shape[0] - 1) / (X_test.shape[0] - X_test.shape[1] - 1)) 
                #)
                ...
                if self.verbose > 0:
                    scores_verbose = {
                        "Model": name,
                        "R-Squared": r_squared,
                        "Adjusted R-Squared": 1 - (1 - r_squared) * ((X_test.shape[0] - 1) / (X_test.shape[0] - X_test.shape[1] - 1)),
                        "RMSE": rmse,
